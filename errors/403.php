<?php
  ...
  $cursor->execute(array(":sc"=>"403", ":ra"=>$public_ip, ":d"=>$current_date, ":t"=>$current_time));
...
<html lang="en">
  <head>
    ...
    <!-- End Favicon -->
    <!-- Start SEO -->
    <title>MiceX.Pro | 403</title>
    <meta name="Author" content="MiceX.Pro" />
    <meta name="description" content="MiceX.Pro 403" />
    <meta name="keywords" content="MiceX, MiceX.Pro, 403" />

    <!-- Start Social Media -->
    <meta property="og:title" content="MiceX.Pro | 403" />
    <meta property="og:description" content="MiceX.Pro 403" />
    <meta
      property="og:image"
    ...
    <meta name="twitter:title" content="MiceX.Pro | 403" />
    <meta name="twitter:description" content="MiceX.Pro 403" />
    <meta
      name="twitter:image"
      content="https://mpod.micex.pro/assets/images/MiceX-logo.png"
    />
  ...
  <body>
    ...
    <section class="section">
      <div class="section-content">
        <img src="./assets/images/errors/403.png" alt="MiceX.Pro" />
